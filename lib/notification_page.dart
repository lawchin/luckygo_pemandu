      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snap) {
          ...
          final visibleDocs = docs.where((doc) {
            ...
            final isRating = desc.toLowerCase().contains('rating');
            final age = now.difference(created).inMinutes;
// CHANGE THE WAINTING TIME HERE ################################################################
// CHANGE THE WAINTING TIME HERE ################################################################
// CHANGE THE WAINTING TIME HERE ################################################################
// CHANGE THE WAINTING TIME HERE ################################################################
            return !isRating || age >= 10;
// CHANGE THE WAINTING TIME HERE ################################################################
// CHANGE THE WAINTING TIME HERE ################################################################
// CHANGE THE WAINTING TIME HERE ################################################################
// CHANGE THE WAINTING TIME HERE ################################################################
          ...
          if (visibleDocs.isEmpty) {
            return const Center(child: Text('No visible notifications yet.'));
          }
