...
class _MyProfileState extends State<MyProfile> {
  ...
  /// Read as int (rounding if it was a double or a numeric string)
    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snap) {
          ...
          // NEW fields
          final joinDate = _date(data['registration_date']);
          final isFixed = _b(data, 'com_fixed_or_percentage'); // true=Fixed, false=Percentage
          final fixedRate = _d(data, 'commission_fixed');
          final percentageRateInt = _i(data, 'commission_percentage'); // ← INT %
              ...
              Card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _line(
                      label: docsCount == 0 ? '' : '$docsCount documents',
                      value: '',
                    ),
                    _spacer(),
                    _line(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _line(
                      ...
                      value: isFixed ? 'Fixed' : 'Percentage',
                    ),
                    if (isFixed) ...[
                      _spacer(),
                      _line(
                      ...
                      _line(
                        ...
                        value: percentageRateInt == 0 ? '' : '$percentageRateInt%',
                      ),
                    ],
                  ],
                ),
