...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> registerUser() async {
    ...
    // NEW: read emergency contacts
    Gv.emergencyContact1 = emergencyContactController.text.trim();
    Gv.emergencyContact2 = secondEmergencyContactController.text.trim();
    ...
    final data = {
      ...
      'registration_remark': '',
      // NEW: save emergency contacts (2nd is optional)
      'emergency_contact1': Gv.emergencyContact1,
      'emergency_contact2': Gv.emergencyContact2,
  ...
  final secondEmergencyContactController  = TextEditingController();
  ...
  void dispose() {
    ...
    emergencyContactController.dispose();        // NEW
    secondEmergencyContactController.dispose();  // NEW
    super.dispose();
  }
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              // NEW: emergency contacts under 2nd phone (same as passenger)
              _buildTextField("Enter emergency contact", emergencyContactController, keyboardType: TextInputType.phone),
              _buildTextField("Enter 2nd emergency contact (Optional)", secondEmergencyContactController, keyboardType: TextInputType.phone, isOptional: true),

              // === Gender selector (kept after emergency fields) ===
